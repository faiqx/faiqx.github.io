export interface Chapter {
  ...
  paragraphs: string[];
  /**
   * Optional case study for this chapter: the `id` of an entry in the `work`
   * collection. Chapters without one simply don't render the link.
   */
...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    caseStudies: [
      { slug: 'go-drug-database-indexer', label: 'How the indexer works' },
    ],
  },
  {
    year: '2025',
